    ...
    this.console.log('scroll load')
      if ($(this).scrollTop() >= 30) {
          if ($header.length) {
            ...
            $headerBtn.removeClass(headerBtnInitial).addClass(headerBtnAlt);
          ...
          if ($header.length) {
              $header.removeClass(headerAlt).addClass(headerInitial);
              $headerBtn.removeClass(headerBtnAlt).addClass(headerBtnInitial);
